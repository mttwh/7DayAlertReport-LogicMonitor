...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    daysOfAlerts = req.params.get('daysOfAlerts')
    
    
    #tries to get the "name" variable from the query parameters, if not will check request body for JSON and look there for "name"
    if not accessId:
        try:
            ...
            daysOfAlerts = req_body.get('daysOfAlerts')
